# Bpost Tracking API For PHP
Bpost Tracking API and webhook make it easy to integrate Bpost Tracking function into your own project. Support APIs Client Libraries for php

### API key

In order to use this API, you need to generate a Bpost Tracking  API key in the [TrackingMore](https://www.trackingmore.com).
...
------------------------------------------------------------------------------------------------------------------
[TrackingMore](https://www.trackingmore.com) is a multiple carrier solutions. Developers can get tracking results from 410+ couriers by integrating trackingmore API.Check the courier code. use Bpost Tracking API of Trackingmore  allows eCommerce developers in any sizes to add package tracking fuction easily. Use [Bpost Tracking API](https://www.trackingmore.com/belgium-post-tracking.html)  to:

   *   Get Bpost realtime tracking info of muti-carriers in one integration
   *   Provide Bpost shipment tracking experience like Amazon
   *   Push Bpost notifications of package update with webhook
   *   Verify Bpost delivery exception before it is too late
